...
class PostImagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post_image" do
    assert_difference('PostImage.count') do
      post post_images_url, params: { post_image: { image_link: @post_image.image_link } }, as: :json
    end
  ...
  test "should update post_image" do
    patch post_image_url(@post_image), params: { post_image: { image_link: @post_image.image_link } }, as: :json
    assert_response 200
  end
